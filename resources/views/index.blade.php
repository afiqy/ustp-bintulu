...
<style>
    ...
    * {
    ...
    background-color: #ddeeff; /* Change this color to the shade you prefer */
}
            ...
            <div id="header-carousel" class="carousel slide carousel-fade" data-bs-ride="carousel">
                <div class="carousel-inner">
                    <div class="carousel-item active">
                        <div class="d-flex justify-content-center align-items-center" style="height: 480px; overflow-x: hidden;">
                            <img style="max-width: 100vw; max-height: 100%; height: auto;" src="{{ asset('img/1.1.png') }}" alt="Image1">
                        </div>
                ...
                <div class="col-lg-12 wow zoomIn" data-wow-delay="0.1s">
                    <div class="bg-primary d-flex flex-column p-4 w-100" style="height: 200px;"> 
                        ...
                        <div class="row">
                            <!-- Sektor Perancangan -->
                            <div class="col">
                                <a class="btn btn-primary border-0" href="#" style="border-radius: 15px;">
                            ...
                            <!-- Sektor Pembelajaran -->
                            <div class="col">
                                <a class="btn btn-primary" href="#" style="border-radius: 15px;">
    ...
    <!-- CONTENT -->
        ...
        <div class="container-fluid my-4">
            <div class="row justify-content-center">
                <div class="col-lg-12 wow zoomIn" data-wow-delay="0.8s">
                    <div class="card border-info shadow">
                        <div class="card-header bg-info text-white">
                            <h3 class="card-title mb-0">Pautan Pantas</h3>
                        </div>
                        <div class="card-body bg-light"> <!-- Move the bg-light class here -->
                            <p class="card-text"></p>
                            <div class="list-group">
                                <a href="{{ url('pautan-pantas') }}" class="list-group-item list-group-item-action list-group-item-light">Sektor Perancangan</a>
                                <a href="{{ url('pautan-pantas') }}" class="list-group-item list-group-item-action list-group-item-light">Sektor Pembelajaran</a>
                                <a href="{{ url('pautan-pantas') }}" class="list-group-item list-group-item-action list-group-item-light">Sektor Pengurusan Sekolah</a>
                                <a href="{{ url('pautan-pantas') }}" class="list-group-item list-group-item-action list-group-item-light">Sektor Pembangunan Murid</a>
                                <a href="{{ url('pautan-pantas') }}" class="list-group-item list-group-item-action list-group-item-light">Sektor Psikologi & Kaunseling</a>
                                <a href="{{ url('pautan-pantas') }}" class="list-group-item list-group-item-action list-group-item-light">Sektor Pentaksiran & Peperiksaan</a>
                                <a href="{{ url('pautan-pantas') }}" class="list-group-item list-group-item-action list-group-item-light">Sektor Pengurusan</a>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="carousel-item active">
                            <div class="row g-2 mb-5">
                                ...
                                <div class="col-md-4">
                                    <div class="service-item">
                                        <div class="rounded-top overflow-hidden">
                                            <img class="img-fluid w-100" src="{{ asset('img/calonspm.jpg')}}" alt="Program Solat Hajat Perdana Pelajar Islam SPM Dan STPM 2023/2024 Peringkat Daerah Bintulu" style="height: 250px;">
                                        </div>
                                ...
                                <div class="col-md-4">
                                    <div class="service-item">
                                        <div class="rounded-top overflow-hidden">
                                            <img class="img-fluid w-100" src="{{ asset('img/pengurusanstress.jpg')}}" alt="Program Pengurusan Stres, Kewangan Berhemah Dan Kesihatan Mental" style="height: 250px;">
                                        </div>
                                        <div class="position-relative bg-light rounded-bottom text-center p-4">
                                ...
                                <div class="col-md-4">
                                    <div class="service-item">
                                        <div class="rounded-top overflow-hidden">
                                            <img class="img-fluid w-100" src="{{ asset('img/riadahjumaat.jpg')}}" alt="The Biggest Loser Siri 1" style="height: 250px;">
                                        </div>
                                        <div class="position-relative bg-light rounded-bottom text-center p-4">
                        ...
                        <div class="carousel-item">
                            <div class="row g-2 mb-5">
                                ...
                                <div class="col-md-4">
                                    <div class="service-item">
                                        <div class="rounded-top overflow-hidden">
                                            <img class="img-fluid w-100" src="{{ asset('img/hariterbuka.jpg')}}" alt="Hari Kerjaya & Pendidikan Dan Hari Terbuka PPD Bintulu" style="height: 250px;">
                                        </div>
                                        <div class="position-relative bg-light rounded-bottom text-center p-4">
                                ...
                                <div class="col-md-4">
                                    <div class="service-item">
                                        <div class="rounded-top overflow-hidden">
                                            <img class="img-fluid w-100" src="{{ asset('img/maulidur.jpg')}}" alt="Program Maulidur Rasul 2023" style="height: 250px;">
                                        </div>
                                        <div class="position-relative bg-light rounded-bottom text-center p-4">
                                ...
                                <div class="col-md-4">
                                    <div class="service-item">
                                        <div class="rounded-top overflow-hidden">
                                            <img class="img-fluid w-100" src="{{ asset('img/pemberkatan.jpg')}}" alt="Program Pemberkatan Calon SPM dan STPM Daerah Bintulu Tahun 2023/2024" style="height: 250px;">
                                        </div>
                                        <div class="position-relative bg-light rounded-bottom text-center p-4">
