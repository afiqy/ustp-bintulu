            ...
            <div class="row g-5">
                <div class="col-lg-12">
                    <div class="section-title mb-4">
                        ...
                        <h4 class="display-5 mb-0">{{__('messages.Maklumat Prasekolah')}}</h4>
                    </div>

                    <div class="obj-frame">
                        <a href="https://smpk.moe.gov.my/" target="_blank" style="text-decoration: none; color: inherit;">
                            <p>{{__('messages.Klik sini untuk ke Sistem Maklumat Prasekolah Kebangsaan.')}}</p>
                        </a>
                    </div>
