            ...
            <div class="row g-5">
                <div class="col-lg-12">
                    <div class="section-title mb-4">
                        ...
                        <h1 class="display-5 mb-0">{{__('messages.Matlamat Pendidikan Sekolah')}}</h1>
                    </div>

                    <div class="obj-frame">
                        <p>{{__('messages.Pendidikan Prasekolah bertujuan menyediakan pengalaman pembelajaran kepada murid-murid yang berumur antara empat hingga enam tahun bagi menyuburkan potensi mereka dalam semua aspek perkembangan, menguasai kemahiran asas dan memupuk sikap positif sebagai persediaan masuk ke sekolah rendah.')}}</p>
