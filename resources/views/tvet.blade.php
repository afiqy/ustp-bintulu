    ...
    <div class="container-fluid bg-primary py-5 hero-header mb-5 obj-frame">
        <div class="row py-3">
            <div class="col-12 text-center">
                <h1 class="display-3 text-white animated zoomIn">PENDIDIKAN TEKNIKAL DAN LATIHAN VOKASIONAL(TVET)</h1>
            </div>
        </div>
    </div>
            ...
            <div class="col-lg-12">
                <div class="obj-frame" id="pra-sekolah-accordion">
                    <ul class="sector-list">
                        ...
                        <!-- Maklumat Umum TVET -->
                        <li>
                            <a href="{{ url('/tvet/maklumat_tvet') }}">Maklumat Umum TVET</a>
                        </li>

                        <!-- Kolej Vokasional -->
                        <li>
                            <a href="{{ url('/tvet/kv') }}">Kolej Vokasional</a>
                        </li>
