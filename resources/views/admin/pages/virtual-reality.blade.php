<x-admin-layout bodyClass="g-sidenav-show  bg-gray-200 virtual-reality">

    <div class="mt-n3">
        <!-- Navbar -->
        <x-admin_navbars.navs.auth titlePage="Virtual Reality"></x-admin_navbars.navs.auth>
        <!-- End Navbar -->
    </div>
    <div class="border-radius-xl mx-2 mx-md-3 position-relative"
        ...
        <x-admin_navbars.sidebar activePage="virtual-reality"></x-admin_navbars.sidebar>
