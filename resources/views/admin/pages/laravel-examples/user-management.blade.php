<x-admin-layout bodyClass="g-sidenav-show  bg-gray-200">
    ...
    <x-admin_navbars.sidebar activePage="user-management"></x-admin_navbars.sidebar>
    <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
        <!-- Navbar -->
        <x-admin_navbars.navs.auth titlePage="User Management"></x-admin_navbars.navs.auth>
        <!-- End Navbar -->
