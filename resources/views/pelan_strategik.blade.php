    ...
    <div class="container-fluid bg-primary py-5 hero-header mb-5">
        <div class="row py-3">
            <div class="col-12 text-center">
                <h1 class="display-3 text-white animated zoomIn">{{__('messages.pelan')}}</h1>
            </div>
        </div>
    </div>
            ...
            <div class="row g-5">
                ...
                <div class="col-lg-8 offset-lg-2 mb-4">
                    ...
                    <div class="text-center">
                        <div class="pdf-title">{{__('messages.pelan')}}</div>
                        <a href="/Pelan Strategik.pdf" class="btn btn-primary mt-3" download>{{__('messages.Muat Turun Pelan')}}</a>
                    </div>
                </div>
            </div>
        </div>
