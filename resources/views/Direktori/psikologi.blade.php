    ...
    <div class="container-fluid bg-primary py-5 hero-header mb-5">
        <div class="row py-3">
            <div class="col-12 text-center">
                <h1 class="display-3 text-white animated zoomIn">{{__('messages.SEKTOR PSIKOLOGI & KAUNSELING')}}</h1>
            </div>
        </div>
    </div>
    ...
    <div class="container">
        <div class="row">
            <div class="col-12">
                ...
                <!-- Ketua Sektor Psikologi -->
                <div class="organizational-chart">
                    <img src="{{ asset('img/S Psikologi & Kaunseling.png') }}" alt="Organizational Chart Sektor Psikologi & Kaunseling">
                </div>
