    ...
    <div class="container-fluid bg-primary py-5 hero-header mb-5">
        <div class="row py-3">
            <div class="col-12 text-center">
                <h1 class="display-3 text-white animated zoomIn">SEKTOR PENTAKSIRAN DAN PEPERIKSAAN</h1>
            </div>
        </div>
    </div>
        ...
        <div class="row">
            <div class="col-12">
                ...
                <div class="organizational-chart">
                    <img src="{{ asset('img/6.png') }}" alt="Organizational Chart SEKTOR PENTAKSIRAN DAN PEPERIKSAAN">
                </div>
            </div>
        </div>
        {{-- ... other sections ... --}}
