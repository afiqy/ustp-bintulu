    ...
    <div class="container-fluid bg-primary py-5 hero-header mb-5">
        <div class="row py-3">
            <div class="col-12 text-center">
                <h1 class="display-3 text-white animated zoomIn">{{__('UNIT PASUKAN TEKNIKAL ICT SEKOLAH')}}</h1>
            </div>
        </div>
    </div>
        ...
        <div class="row">
            <div class="col-12">
                ...
                <div class="organizational-chart">
                    <img src="{{ asset('img/PTICT.png') }}" alt="Organizational Chart Unit ICT">
                </div>
            </div>
        </div>
        {{-- ... other sections ... --}}
            ...
            <div class="row">
                <div class="col-md-6 g-4">
                    <div class="chart-box">
                        ...
                        <ul>
                            <li>Sebarina Binti Siji (Penyelaras PTIS)</li>
