    ...
    <div class="container-fluid bg-primary py-5 hero-header mb-5">
        <div class="row py-3">
            <div class="col-12 text-center">
                <h1 class="display-3 text-white animated zoomIn">{{__('messages.SEKTOR PERANCANGAN')}}</h1>
            </div>
        </div>
    </div>
        ...
        <div class="row">
            <div class="col-12">
                ...
                <div class="organizational-chart">
                    <img src="{{ asset('img/S Perancangan.png') }}" alt="Organizational Chart Sektor Perancangan">
                </div>
            </div>
        </div>
        {{-- ... other sections ... --}}
        ...
        <div class="chart-container">
            ...
            <div class="row">
                ...
                <div class="col-md-6 g-4">
                    <div class="chart-box">
                        <h3>iKOMPAS</h3>
                        <p>Siti Norfassehah binti Arifin<br>Penolong PPD</p>
                    </div>
                </div>
                <div class="col-md-6 g-4">
                    <div class="chart-box">
                ...
                <div class="col-md-6 g-4">
                    <div class="chart-box">
                        <h3>Pelan Strategik atau Takwim</h3>
                        <p>Evelyn Eba anak Nompang<br>Penolong PPD</p>
                        <br><p></P>
                    </div>
                </div>
