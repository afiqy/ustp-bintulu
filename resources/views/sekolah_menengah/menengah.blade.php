            ...
            <div class="row g-5">
                <div class="col-lg-12">
                    <div class="section-title mb-4">
                        ...
                        <h4 class="display-5 mb-0">{{__('messages.Sekolah Menengah Kebangsaan (Harian)')}}</h4>
                    </div>

                    <div class="obj-frame">
                        <h5><strong>{{__('messages.PENDAFTARAN')}}</strong></h5>
                        <p>{{__('messages.Melalui Penempatan:')}}</p>
                        <ul>
                            <li>{{__('messages.Guru kelas Tahun 6 SK/SRAB/SJKC /SJKT menggunakan aplikasi APDM (Modul e-Daftar Menengah) bagi murid warganegara sahaja berdasarkan Borang Permohonan Penempatan Sekolah (BPPS) yang dilengkapkan oleh ibu bapa/penjaga.')}}</li>
                        ...
                        <p>{{__('messages.Melalui Permohonan:')}}</p>
                        <ul>
                            <li>{{__('messages.Murid Bukan Warganegara boleh memohon menggunakan Borang PU(A)275 Jadual Pertama melalui Unit Perhubungan dan Pendaftaran di JPN. Borang boleh diperolehi dari Pejabat Pendidikan Daerah yang berhampiran.')}}</li>
                        </ul>
                        <h5><strong>{{__('messages.SENARAI SEKOLAH')}}</strong></h5>
                        <ul>
