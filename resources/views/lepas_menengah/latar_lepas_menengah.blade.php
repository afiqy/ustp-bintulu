            ...
            <div class="row g-5">
                <div class="col-lg-12">
                    <div class="section-title mb-4">
                        ...
                        <h4 class="display-5 mb-0">{{__('messages.Latar Belakang')}}</h4>
                    </div>

                    <div class="obj-frame">
                        <p>{{__('messages.Akta Pendidikan 1996 (Akta 550), menyatakan “pendidikan lepas menengah” ertinya Pendidikan yang disediakan untuk seseorang yang sudah tamat mengikut Pendidikan lepas menengah, tetapi tidak termasuk Pendidikan Tinggi.')}}</p>
                        <p>{{__('messages.Tingkatan 6 telah mula beroperasi di sekolah menengah kerajaan dan sekolah menengah bantuan kerajaan lebih daripada 50 tahun dahulu. Pada masa itu, bilangan kelas Tingkatan 6 yang di tawarkan ialah minimum 2 kelas dan maksimum 22 kelas. Terdapat 2 bidang yang ditawarkan iaitu bidang Sains Sosial (Kemanusiaan dan Agama) dan Bidang Sains.')}}</p>
                        ...
                        <p>{{__('messages.Manakala pelaksanaan sistem pentaksiran baharu STPM telah dimulakan pada tahun 2012 setelah diluluskan oleh Mesyuarat Jemaah Menteri (MJM) pada 4 Januari 2012.')}}</p>
                        <p>{{__('messages.Tempoh pengajian di Tingkatan 6 adalah selama tiga semester. Murid yang telah menamatkan pengajian menengah atas dan telah menduduki peperiksaan Sijil Pelajaran Malaysia (SPM), layak untuk ditawarkan pengajian di Tingkatan 6 jika memenuhi syarat umum dan syarat khusus bagi bidang yang ditawarkan.')}}</p>
                    </div>
