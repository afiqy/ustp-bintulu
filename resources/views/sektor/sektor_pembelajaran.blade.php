    ...
    <div class="row">
        <div class="col-md-6 mb-4">
            <div class="card h-100">
                <div class="card-body">
                    <h5 class="card-text">Description or brief overview of Link 1 goes here.</h5>
        ...
        <div class="col-md-6 mb-4">
            <div class="card h-100">
                <div class="card-body">
                    <h5 class="card-text">Description or brief overview of Link 2 goes here.</h5>
                    <a href="#" target="_blank" class="btn btn-primary">Klik</a>
                </div>
            </div>
        </div>
        <div class="col-md-6 mb-4">
            <div class="card h-100">
                <div class="card-body">
                    <h5 class="card-text">Description or brief overview of Link 3 goes here.</h5>
                    <a href="#" target="_blank" class="btn btn-primary">Klik</a>
                </div>
            </div>
        </div>
        <div class="col-md-6 mb-4">
            <div class="card h-100">
                <div class="card-body">
                    <h5 class="card-text">Description or brief overview of Link 4 goes here.</h5>
                    <a href="#" target="_blank" class="btn btn-primary">Klik</a>
                </div>
            </div>
        </div>
        <div class="col-md-6 mb-4">
            <div class="card h-100">
                <div class="card-body">
                    <h5 class="card-text">Description or brief overview of Link 5 goes here.</h5>
                    <a href="#" target="_blank" class="btn btn-primary">Klik</a>
                </div>
            </div>
        </div>
        <div class="col-md-6 mb-4">
            <div class="card h-100">
                <div class="card-body">
                    <h5 class="card-text">Description or brief overview of Link 6 goes here.</h5>
                    <a href="#" target="_blank" class="btn btn-primary">Klik</a>
                </div>
            </div>
        </div>
