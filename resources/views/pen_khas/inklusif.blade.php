            ...
            <div class="row">
                <div class="col-lg-8">
                    <div class="section-title mb-3">
                        ...
                        <h1 class="display-6 mb-0">Program Pendidikan Inklusif</h1>
                    </div>
                </div>
            </div>
                    ...
                    <div class="accordion" id="pra-sekolah-accordion">
                        ...
                        <div class="accordion-item">
                            ...
                            <div id="objektif-collapse-1" class="accordion-collapse collapse" aria-labelledby="objektif-heading-1" data-bs-parent="#pra-sekolah-accordion">
                                <div class="accordion-body">
                                    ...
                                    <p><strong>Konsep Program Pendidikan Inklusif (PPI) adalah selaras dengan penyataan dalam Peraturan - peraturan Pendidikan (Pendidikan Khas) 2013 seperti di bawah : </strong></p>
                                    <ul>
                                        <li>"Program Pendidikan Inklusif" ertinya suatu program pendidikan bagi murid berkeperluan pendidikan khas yang dihadiri oleh murid berkeperluan khas bersama-sama dengan murid lain dalam kelas yang sama di sekolah kerajaan atau sekolah bantuan kerajaan.</li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="accordion-item">
                            ...
                            <div id="objektif-collapse-3" class="accordion-collapse collapse" aria-labelledby="objektif-heading-3" data-bs-parent="#pra-sekolah-accordion">
                                <div class="accordion-body">
                                    <i><b><p style="font-size: 18px;"></p></b></i>
                                    <p><strong>Inklusif Penuh</strong></p>
                                    <ul>
                                        <li>MBK belajar secara sepenuh masa bersama-sama murid arus perdana. MBK mengikuti pembelajaran bagi semua mata pelajaran akademik berasaskan kurikulum kebangsaan atau kurikulum kebangsaan yang diubahsuai dengan bantuan atau tanpa bantuan perkhidmatan sokongan.</li>
                                    </ul>
                                    <p><strong>Inklusif Separa</strong></p>
                                    <ul>
                                        <li>MBK belajar bersama-sama murid arus perdana bagi mata pelajaran akademik atau aktiviti koakademik atau aktiviti kokurikulum tertentu sahaja mengikut keupayaan mereka. MBK yang mengikuti inklusif separa bagi mata pelajaran akademik berasaskan kurikulum kebangsaan atau kurikulum kebangsaan yang diubahsuai dengan sedikit atau tanpa bantuan perkhidmatan sokongan. Inklusif separa bagi aktiviti koakademik atau kokurikulum adalah berdasarkan potensi, bakat dan keupayaan mereka.</li>
                                    </ul>
                                </div>
                            </div>
                        </div>
