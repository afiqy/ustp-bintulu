...
Route::group(['middleware' => ['setLocale', 'guest']], function(){
    ...
    Route::get('/get-activities', [ActivityController::class, 'getActivities']);
    Route::post('/activities', [ActivityController::class, 'store'])->name('activities.store');
    Route::get('/activities/{date}', [ActivityController::class, 'getActivitiesForDate'])->name('activities.date');
...
Route::group(['middleware' => ['auth']], function(){
    ...
    Route::get('/lang/{locale}', function($locale){
        ...
        return redirect()->route('home'); // Redirect to the homepage or any other appropriate route
    })->name('locale');
