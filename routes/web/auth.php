...
use App\Http\Controllers\Auth\RegisterController; // Change this
...
use App\Http\Controllers\SektorPerancanganController;
use App\Http\Controllers\SektorPengurusanSekolahController;
use App\Http\Controllers\SektorPembelajaranController;
use App\Http\Controllers\SektorPembangunanMuridController;
use App\Http\Controllers\SektorPsikologiController;
use App\Http\Controllers\SektorPengurusanController;
use App\Http\Controllers\SektorPentaksiranController;
...
Route::group(['middleware' => ['auth']], function () {
    ...
    Route::get('/activities', [TakwimController::class, 'index']);
    Route::get('/activities/{date}', [TakwimController::class, 'getActivitiesByDate']);
    Route::post('/activities', [TakwimController::class, 'store'])->name('activities.store');
    Route::delete('/activities/{id}', [TakwimController::class, 'destroy']);
    ...
    // This line is for BIG DATA of website...
    Route::middleware(['auth','sektor_perancangan'])->group(function () {
        Route::get('/sektor-perancangan', [SektorPerancanganController::class, 'index'])->name('BigData.sektor-perancangan');
    });

    Route::middleware(['auth', 'sektor_pembelajaran'])->group(function () {
        Route::get('/sektor-pembelajaran', [SektorPembelajaranController::class, 'index'])->name('BigData.sektor-pembelajaran');
    });

    Route::middleware(['auth', 'sektor_pengurusan_sekolah'])->group(function () {
        Route::get('/sektor-pengurusan-sekolah', [SektorPengurusanSekolahController::class, 'index'])->name('BigData.sektor-pengurusan-sekolah');
    });

    Route::middleware(['auth', 'sektor_pembangunan_murid'])->group(function () {
        Route::get('/sektor-pembangunan-murid', [SektorPembangunanMuridController::class, 'index'])->name('BigData.sektor-pembangunan-murid');
    });

    Route::middleware(['auth', 'sektor_psikologi'])->group(function () {
        Route::get('/sektor-psikologi', [SektorPsikologiController::class, 'index'])->name('BigData.sektor-psikologi');
    });

    Route::middleware(['auth', 'sektor_pentaksiran'])->group(function () {
        Route::get('/sektor-pentaksiran', [SektorPentaksiranController::class, 'index'])->name('BigData.sektor-pentaksiran');
    });

    Route::middleware(['auth', 'sektor_pengurusan'])->group(function () {
        Route::get('/sektor-pengurusan', [SektorPengurusanController::class, 'index'])->name('BigData.sektor-pengurusan');
    });
